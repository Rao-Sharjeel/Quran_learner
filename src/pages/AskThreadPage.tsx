            ...
            <div className="mt-6 rounded-2xl bg-brand-50/60 px-4 py-5 ring-1 ring-brand-100">
              ...
              {endorsers.length > 0 ? (
                <div className="mt-5 flex flex-col gap-4 border-t border-brand-100 pt-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <ButtonLink to={`/teachers/${leadScholar!.id}`} className="!rounded-xl !text-sm">
          ...
          <div className="mt-4 space-y-3">
            {clarifications.length === 0 ? (
              ...
              clarifications.map((c) => {
                ...
                return (
                  <div key={c.id} className="rounded-xl bg-surface/80 px-3.5 py-3.5 ring-1 ring-line/60">
                    ...
                    {c.studentReply ? (
                      ...
                      <div className="mt-2 space-y-2">
                        ...
                        />
                        <Button type="button" className="!rounded-xl !text-sm" onClick={() => onReply(c.id)}>
                          Send reply
                        </Button>
                      </div>
                    )}
        ...
        <section className="rounded-2xl bg-canvas p-5 shadow-sm ring-1 ring-line/80 sm:p-6">
          ...
          <div className="mt-4 space-y-2">
            {comments.length === 0 ? (
              ...
              comments.map((c) => (
                <div key={c.id} className="rounded-xl bg-surface/70 px-3.5 py-3 ring-1 ring-line/50">
