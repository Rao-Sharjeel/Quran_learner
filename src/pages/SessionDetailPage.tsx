...
import { isSessionJoinOpen } from '../lib/sessionJoin'
import { useState } from 'react'
import { MobileSessionDetail } from '../components/sessions/MobileSessionDetail'
...
export function SessionDetailPage() {
  ...
  const canJoin = eligible && isSessionJoinOpen(session)
  ...
  return (
    <>
      <MobileSessionDetail
        ...
        onPrivateChange={setPrivateDraft}
        onPrivateBlur={onPrivateBlur}
        onToggleHomework={(itemId) => toggleHomeworkDone(session.id, itemId)}
      />
